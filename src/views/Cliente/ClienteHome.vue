<template>
    <nav class="sticky top-0 bg-gray-800">
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="flex space-x-4">
                    ...
                    <router-link class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page" to="/cliente/catalogo">Catalogo</router-link>
        ...
        <div v-show="this.modal.mobilNav" class="sm:hidden" id="mobile-menu">
            ...
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <router-link class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page" to="/cliente/catalogo">Catalogo</router-link>
            <router-link class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" to="/cliente/pedidos">Pedidos</router-link>
            </div>
        </div>
        </nav>
        <br>
